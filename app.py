...
app.config['MAIL_USERNAME'] = 'vansh908070@gmail.com'
app.config['MAIL_PASSWORD'] = 'fxbfrlmfgpbiaren'
...
def mailme():
    ...
    msg = Message(subject=message_subject, sender=sender_email, recipients=['vansh908070@gmail.com'])
